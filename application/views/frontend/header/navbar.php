...
<head>
    ...
    <title>Sintesa Learning</title>

    <!-- Bootstrap Core CSS -->
    <link type="text/css" href="<?php echo $assets_location;?>dist/css/bootstrap.css" rel="stylesheet" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="<?php echo $assets_location;?>dist/css/freelancer.css" rel="stylesheet">
    <!-- <link href="<?php echo $assets_location;?>dist/css/agency.css" rel="stylesheet"> -->
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Sintesa Learning</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="#portfolio">Artikel</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#services">Beli Buku</a>
                    </li>
                    <li class="page-scroll">
